      ...
      <div className="top-bar-left">
        <ul className="menu">
          <li className="menu-text">
            <i className="fa fa-home"></i> React Weather App
          </li>
          <li>
            <IndexLink to="/" activeClassName="active" activeStyle={{fontWeight: 'bold'}}><i className="fa fa-sun-o"></i> Get Weather</IndexLink>
          </li>
          <li>
            <Link to="/about" activeClassName="active" activeStyle={{fontWeight: 'bold'}}><i className="fa fa-info-circle"></i> About</Link>
          </li>
          <li>
            <Link to="/examples" activeClassName="active" activeStyle={{fontWeight: 'bold'}}><i className="fa fa-tasks"></i> Examples</Link>
          </li>
        </ul>
      </div>
